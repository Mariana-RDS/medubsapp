...
import com.example.medicamentosubs.model.User
import com.example.medicamentosubs.model.toFBUser
            ...
            Column(
                ...
                Button(
                    onClick = {
                        ...
                        FirebaseH.register(name, email, password) { success, error ->

                            if (success) {

                                val user = User(name, email)
                                FBDatabase().register(user.toFBUser())
